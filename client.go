...
var (
	...
	CmdCreateWithdrawal    = "create_withdrawal"
)
...
func SupportedCommands() []string {
	return []string{CmdCreateTransaction, CmdGetBasicInfo, CmdRates, CmdBalances, CmdGetCallbackAddress, CmdGetDepositAddress, CmdGetTxInfo, CmdGetTxInfoMulti, CmdGetTxList, CmdCreateTransfer, CmdCreateWithdrawal}
}
